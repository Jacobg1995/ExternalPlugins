 ...
 */
package net.runelite.client.plugins.externals.AutoAttackPrayer;
...
@Extension
@PluginDescriptor(
	name = "Auto Attack Prayer",
	description = "Auto Swaps Prayer to incoming attack style",
	tags = {"Prayer", "bot", "Auto"}
)
@Slf4j
@SuppressWarnings("unused")
@PluginDependency(ExtUtils.class)
public class AutoAttackPrayer extends Plugin
{
	@Inject
	...
	@Inject
	private AutoAttackPrayerConfig config;
	@Inject
	...
	@Provides
	AutoAttackPrayerConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(AutoAttackPrayerConfig.class);
	}
	...
	{
		if (!event.getGroup().equals("AutoAttackPrayerConfig"))
		{
			return;
		}
