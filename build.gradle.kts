...
subprojects {
    ...
    dependencies {
        ...
        compileOnly(group = "com.openosrs", name = "http-api", version = "4.8.1")
        compileOnly(group = "com.openosrs", name = "runelite-api", version = "4.8.1")
        compileOnly(group = "com.openosrs", name = "runelite-client", version = "4.8.1")
        compileOnly(group = "com.openosrs.rs", name = "runescape-client", version = "4.8.1")
        compileOnly(group = "com.openosrs.rs", name = "runescape-api", version = "4.8.1")
